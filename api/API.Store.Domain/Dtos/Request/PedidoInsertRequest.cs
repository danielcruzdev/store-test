...
{
    public class PedidoInsertRequest
    {
        ...
        public List<ItensPedidoInsertRequest> ItensPedido { get; set; } = new List<ItensPedidoInsertRequest>();
    }

    public class ItensPedidoInsertRequest
    {
